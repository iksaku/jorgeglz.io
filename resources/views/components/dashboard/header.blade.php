        ...
        <div>
            ...
            <div class="relative">
                <div
                    ...
                    class="absolute z-50 top-2 right-0 min-w-full flex flex-col bg-gray-100 dark:bg-gray-700 border border-gray-400 dark:border-gray-600 rounded-lg shadow-xl overflow-hidden transform origin-top-right duration-75"
                ...
                >
                    <span class="md:hidden w-full text-center font-medium p-4 border-b border-gray-400 dark:border-gray-600 whitespace-no-wrap">
                        {{ Auth::user()->name }}
                    </span>
