...
@section('content')
    <div class="h-full min-w-0 w-full">
        <div class="w-full p-4 md:px-6">
            <div class="w-full mb-4 flex items-center justify-end">
                <div class="flex items-center justify-between">
                    <a
                        ...
                        class="text-gray-700 hocus:text-gray-100 text-center bg-gray-100 hocus:bg-blue-500 focus:shadow-outline focus:outline-none px-4 py-2 rounded-lg shadow transform duration-200"
                    >
            ...
            <div class="-mx-4 md:mx-0 overflow-hidden md:rounded-lg border shadow">
