...
export const meta = {
  ...
  description:
    'Looking for a way to integrate Tinkerwell in your Application Menu? Well, letme teach you how to do it!',
  date: '2021-02-19T00:00-06:00',
  image: header,
}
...
[`tinker`](https://github.com/laravel/tinker) tool. :thinking:
...
to index and display your application in their main menu :crystal_ball:.
...
quick access entry in your application menu :running_man:.
