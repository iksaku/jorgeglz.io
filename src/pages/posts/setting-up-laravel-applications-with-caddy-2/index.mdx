...
to feel like a burden :woozy_face:.
...
1. Caddy is HTTPS-first, so I don’t need to worry about certbot trying to renew
   ...
   manages this for me automatically :sparkling_heart:.
...
started to work :man_technologist:.

## Getting Started with Caddy

First of all, you need to install Caddy on your server (obviously), you can find
a pretty detailed guide on
[Caddy’s Documentation](https://caddyserver.com/docs/). So just go and surf the
documentation before coming back.
...
handles SSL certificates for you! :heart_eyes:. No need to define port 443, no
need to have a folder with certificates, all is handled automatically by Caddy
and it’s internal Let’s Encrypt integration :partying_face:.

Up to this point, everything should be OK for you, you can start copy-pasting
this template for all your websites! :rocket:
...
your applications, so keep it as simple as you can :wink:.
